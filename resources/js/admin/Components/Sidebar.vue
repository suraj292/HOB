    ...
    <div class="nk-sidebar">
        <div class="nk-nav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li class="mega-menu mega-menu-sm"><a class="has-arrow" href="#" aria-expanded="false"><i class="mdi mdi-page-layout-body"></i><span class="nav-text">Product</span><span class="badge badge-success nav-badge">11</span></a>
                    <ul aria-expanded="false">
                        <li><router-link :to="{ name: 'AdminProduct' }">Category</router-link>
                        </li>
                        <li><a href="./layout-boxed.html">Sub Category</a>
                        </li>
                        <li><a href="./layout-boxed.html">Product</a>
                        </li>
                    </ul>
                </li>
                <li class="mega-menu mega-menu-sm">
                    <router-link class="" :to="{ name: 'AdminCoupon' }" aria-expanded="false">
                        <i class="mdi mdi-page-layout-body"></i>
                        <span class="nav-text">Coupon</span>
                    </router-link>
                </li>
                <li class="nav-label">Apps</li>
                <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-email-outline"></i> <span class="nav-text">Email</span><span class="badge bg-lgreen text-white nav-badge">০3</span></a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-application"></i><span class="nav-text">Apps</span> <span class="badge badge-info nav-badge">05</span></a>
                    <ul aria-expanded="false">
                ...
                <li><a class="has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-ticket"></i><span class="nav-text">Ticket</span> <span class="badge bg-lgreen text-white nav-badge">02</span></a>
                    <ul aria-expanded="false">
