<template>
    <div class="product-area section-padding-3 padding-20-row-col pt-110 pb-90">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="trending-product-wrap default-overlay overly-point-1-hover mb-20 wow shortfadeInUp custom-delay-400">
                ...
                <div class="col-lg-8">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <div class="trending-product-wrap default-overlay overly-point-1-hover mb-20 wow shortfadeInUp custom-delay-600">
                                <div class="trending-product-img img-zoom">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="trending-product-wrap default-overlay overly-point-1-hover mb-20 wow shortfadeInUp custom-delay-800">
                                <div class="trending-product-img img-zoom">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="trending-product-wrap default-overlay overly-point-1-hover mb-20 wow shortfadeInUp custom-delay-700">
                                <div class="trending-product-img img-zoom">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="trending-product-wrap default-overlay overly-point-1-hover mb-20 wow shortfadeInUp custom-delay-900">
                                <div class="trending-product-img img-zoom">
